        ...
        <div class="card-body">
            <form action="{{ route('dosen.store') }}" method="post">
                ...
                <div class="form-group">
                    <label for="nama_dosen">Kode Dosen</label>
                    <input type="text" class="form-control @error('kode_dosen') is-invalid @enderror" name="kode_dosen" id="kode_dosen" placeholder="Kode Dosen" autocomplete="off" value="{{ old('kode_dosen') }}">
                    @error('kode_dosen')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_dosen') is-invalid @enderror" name="nama_dosen" id="nama_dosen" placeholder="Nama Dosen" autocomplete="off" value="{{ old('nama_dosen') }}">
                    @error('nama_dosen')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
