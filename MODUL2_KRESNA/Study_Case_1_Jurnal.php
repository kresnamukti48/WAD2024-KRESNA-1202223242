...
if(empty($MK_KI1201) || empty($MK_KU1202) || empty($MK_KU1102)){
    $error = "Index tidak boleh kosong!";
}
...
// silakan taruh code kalian di bawah
// **********************  3  ************************** 
if(($MK_KU1202 == 'AB' && $MK_KU1102 == 'B' && $MK_KI1201 != 'A') || ($MK_KU1202 == 'A' && $MK_KU1102 == 'AB' && $MK_KI1201 != 'A')  || ($MK_KU1202 == 'A' && $MK_KU1102 == 'A' && $MK_KI1201 != 'A') || ($MK_KU1202 == 'AB' && $MK_KU1102 == 'A' && $MK_KI1201 != 'A') || (($MK_KU1202 == 'AB' && $MK_KU1102 == 'AB' && $MK_KI1201 != 'A'))){
    $hasil = "Dapat mengambil Kimia Pangan";
}elseif($MK_KI1201 == 'A'){
    $hasil = "Dapat mengambil Kimia Umum";
}else{
    $hasil = "Tidak dapat mengambil MK Kimia";
}
